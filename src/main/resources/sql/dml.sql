INSERT INTO review_tb(review_no, review_title, review_content, book_mark_cnt, like_cnt, report_cnt, member_no)
VALUES (1, '매실 못먹음', '컴프즈 문닫음', 0, 0, 0, 1),
       (2, '두번째 리뷰', '두번째 내용', 0, 0, 0, 2),
       (3, '세번째 리뷰', '세번째 내용', 0, 0, 0, 3),
       (4, '네번째 리뷰', '네번째 내용', 0, 0, 0, 4),
       (5, '다섯번째 리뷰', '다섯번째 내용', 0, 0, 0, 5),
       (6, '여섯번째 리뷰', '여섯번째 내용', 0, 0, 0, 6),
       (7, '일곱번째 리뷰', '일곱번째 내용', 0, 0, 0, 7),
       (8, '여덟번째 리뷰', '여덟번째 내용', 0, 0, 0, 8),
       (9, '아홉번째 리뷰', '아홉번째 내용', 0, 0, 0, 9),
       (10, '열번째 리뷰', '열번째 내용', 0, 0, 0, 10),
       (11, '열한번째 리뷰', '열한번째 내용', 0, 0, 0, 11),
       (12, '열두번째 리뷰', '열두번째 내용', 0, 0, 0, 12),
       (13, '열세번째 리뷰', '열세번째 내용', 0, 0, 0, 13),
       (14, '열네번째 리뷰', '열네번째 내용', 0, 0, 0, 14),
       (15, '열다섯번째 리뷰', '열다섯번째 내용', 0, 0, 0, 15);
...
insert into tag_tb(tag_id, tag_name)
values (1, '자바'),
       (2, '자바스크립트'),
       (3, '파이썬');